...
app.post('/uploadJson', body().isObject(), async (req: Request, res: Response, next: NextFunction) => {
...
app.post('/uploadFile', upload.single('file'), async (req: Request, res: Response, next: NextFunction) => {
    if (!req.file) {
